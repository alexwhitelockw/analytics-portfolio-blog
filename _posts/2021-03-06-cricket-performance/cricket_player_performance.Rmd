...
A simple linear model now follows, wherein we regress performance in the 2019/20 season on the prior season's performance (2018/19; Table \@ref(tab:predPerf2019)). Figure \@ref(fig:plot1920Model) plots the regression model of 2019/20 season performance on to 2018/19 season performance along with the regression line uncertainty.
